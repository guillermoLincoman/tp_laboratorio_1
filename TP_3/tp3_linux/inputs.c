 ...
 *
 * \param char num[]: palabra a validar
 *
 * \return retorna 0 si es un numero 1 si son letras
 *
 */
...
/** \brief Pide, valida y devuelve un numero entero
 *
 * \param char* cadena: palabra a pasar a minuscula
 *
 */
void cadenaMinuscula(char * cadena)
{
    int i;
    int cont = strlen(cadena);
    for (i=0; i < cont; ++i)
    {
